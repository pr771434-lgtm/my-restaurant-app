...
import { FaSearch, FaWhatsapp, FaLeaf, FaShoppingBag } from 'react-icons/fa';
...
const menuData = [
  ...
  // Screenshot mein 'C' capital hai 'Crispy corn.jpg' mein
  ...
  { id: 6, category: "Starters", name: "Mushroom Duplex", price: 260, img: "/Mushroom Duplex.jpg", desc: "Stuffed mushrooms fried to perfection." },
  ...
  // Is file ka naam screenshot mein bahut lamba hai, dhyan se match kiya hai
  ...
  { id: 12, category: "Main Course", name: "Kadhai Paneer", price: 300, img: "/Kadai Paneer.jpg", desc: "Cottage cheese with bell peppers and ground spices." },
  ...
  // FAST FOOD
  // 'Sandwitch' spelling aapke sidebar mein 'w-i-t-c-h' hai
  ...
  { id: 18, category: "Fast Food", name: "Veg Manchurian", price: 200, img: "/Easy Veg Manchurian.jpg", desc: "Deep fried veg balls in a tangy soy ginger sauce." },
